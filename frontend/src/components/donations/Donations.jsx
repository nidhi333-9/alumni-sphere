              ...
              return (
                ...
                >
                  <div className="relative">
                    ...
                    />
                    <span
                      className={`absolute top-3 left-3 px-3 py-1 text-xs font-semibold text-white rounded-full shadow-md ${categoryColors[cause.category] || "bg-gray-600"
                        }`}
                    >
                      {cause.category}
                    </span>
                  ...
                  <div className="p-6">
                    ...
                    <div
                      className={`w-full rounded-full h-3 mb-4 ${categoryLightColors[cause.category] || "bg-gray-200"
                        }`}
                    >
                      <div
                        className={`h-3 rounded-full ${categoryColors[cause.category] || "bg-gray-600"
                          }`}
